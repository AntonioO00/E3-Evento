...
public class Gerenciador {
    ...
    public boolean cadastraT(String codigo, String data, double longitude, double latitude, double magnitude) {
    ...
    public boolean cadastraC(String codigo, String data, double longitude, double latitude, double velocidde, double precipitacao) {
    ...
    public boolean cadastraT(String codigo, String data, double longitude, double latitude, int estiagem) {
